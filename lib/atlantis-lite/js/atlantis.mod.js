...
$(document).ready(function(){
	...
	if (typeof $.fn.scrollbar === 'function') {
		...
		if (scrollbarDashboard.length > 0) scrollbarDashboard.scrollbar();

		var contentScrollbar = $('.main-panel .content-scroll');
		if (contentScrollbar.length > 0) contentScrollbar.scrollbar();

		var messagesScrollbar = $('.messages-scroll');
		if (messagesScrollbar.length > 0) messagesScrollbar.scrollbar();

		var tasksScrollbar = $('.tasks-scroll');
		if (tasksScrollbar.length > 0) tasksScrollbar.scrollbar();

		var quickScrollbar = $('.quick-scroll');
		if (quickScrollbar.length > 0) quickScrollbar.scrollbar();

		var messageNotifScrollbar = $('.message-notif-scroll');
		if (messageNotifScrollbar.length > 0) messageNotifScrollbar.scrollbar();
		...
		if (quickActionsScrollbar.length > 0) quickActionsScrollbar.scrollbar();

		var userScrollbar = $('.dropdown-user-scroll');
		if (userScrollbar.length > 0) userScrollbar.scrollbar();
